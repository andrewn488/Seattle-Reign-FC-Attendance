...
# need to convert responses to numbers then set as.numeric
...
+ data appears to be tidy
    ...
    - survey responses all uniform formatting
...
**Comments**
    ...
    - all variables are agree/disagree character responses
    - should this be converted to numerical to be interpreted as likert scale?
